...
export const SCENE_DESCRIPTORS: Readonly<Record<SceneId, SceneDescriptor>> = {
  ...
  "island-entry": descriptor("island-entry", "OVERVIEW", "introduce-project", ["BACK_TO_WORLD", "BACK_TO_FOCUS", "START_CASE_STUDY"]),
  "case-study-transition": descriptor("case-study-transition", "OVERVIEW", "enter-project-world", ["BACK_TO_WORLD", "BACK_TO_FOCUS"]),
  "case-study-world": descriptor("case-study-world", "OVERVIEW", "guide-content", ["BACK_TO_WORLD", "BACK_TO_FOCUS"]),
