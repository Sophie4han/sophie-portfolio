...
export const SCENE_DESCRIPTORS: Readonly<Record<SceneId, SceneDescriptor>> = {
  ...
  "case-study-transition": descriptor("case-study-transition", "OVERVIEW", "enter-project-world", ["BACK_TO_WORLD"]),
  "case-study-world": descriptor("case-study-world", "OVERVIEW", "guide-content", ["BACK_TO_WORLD"]),
