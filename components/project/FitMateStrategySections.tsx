...
export function ProductStrategySection() {
  return <div className={fitmate.study}>
    <Intro number="01" label="PRODUCT STRATEGY" title="기능을 먼저 쌓기보다, ‘함께 운동하게 만드는 핵심 경험’부터 정의했습니다." paragraphs={[
    ...
    <Chapter number="01-01" label="PRODUCT DEFINITION">
    ...
    <Chapter number="01-02" label="CORE PRODUCT LOOP" title="연결을 기능 하나로 끝내지 않고, 다음 운동까지 이어지는 경험으로 설계했습니다.">
    ...
    <Chapter number="01-03" label="MVP PRIORITIZATION" title="모든 기능을 한 번에 구현하지 않고, 핵심 운동 경험이 완결되는 흐름부터 만들었습니다.">
