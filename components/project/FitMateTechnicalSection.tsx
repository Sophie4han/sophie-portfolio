...
export function DesignTechnicalSection() {
  return <div className={tech.study}>
    <header className={tech.intro}>
      <p className={shared.eyebrow} data-reading-focus>03 / DESIGN SYSTEM &amp; TECHNICAL FLOW</p>
    ...
    <section className={tech.major} aria-labelledby="fitmate-design-system-title">
      ...
      <Block label="A-01 / UI COMPONENT SYSTEM" title="반복되는 화면 요소를 하나의 인터랙션 언어로 정리했습니다.">
      ...
      <Block label="A-02 / COLOR & TYPOGRAPHY" title="색과 글자의 역할을 경험의 목적에 맞춰 분리했습니다.">
    ...
    <section className={tech.major} aria-labelledby="fitmate-technical-planning-title">
      ...
      <Block label="B-01 / ARCHITECTURE" ownership="TEAM PRODUCT ARCHITECTURE" title="실시간 상태와 데이터 흐름을 UI 로직과 분리해 관리했습니다.">
      ...
      <Block label="B-02 / 01 ENTRY FLOW" ownership="MY CONTRIBUTION" title="로그인은 하나의 화면이 아니라, 최초 사용자 상태를 결정하는 흐름이었습니다.">
      ...
      <Block label="B-03 / 02 MATE CONNECTION" ownership="MY CONTRIBUTION" title="메이트 연결 여부가 다음 사용자 행동을 결정하도록 설계했습니다.">
      ...
      <Block label="B-04 / 03 REAL-TIME EXERCISE" ownership="TEAM PRODUCT SYSTEM" title="두 사용자의 운동 데이터를 하나의 세션 경험으로 연결했습니다.">
      ...
      <Block label="B-05 / 04 SESSION STATE" ownership="TEAM PRODUCT SYSTEM" title="정상 Flow뿐 아니라, 운동이 중단되는 순간까지 상태로 정의했습니다.">
      ...
      <Block label="B-06 / 05 DATA STRUCTURE" ownership="TEAM PRODUCT SYSTEM" title="화면보다 먼저, 어떤 상태를 저장하고 연결할지 정의했습니다.">
      ...
      <Block label="B-07 / 06 REWARD LOOP" ownership="MY CONTRIBUTION" title="운동 결과를 제품 안에서 다시 사용할 수 있는 상태로 연결했습니다.">
